...
<form align="center" name="form" action="webs_markcalled.php" onsubmit="return validate()" method="POST">
<?php
...
if(isset($_REQUEST['submitted']))
{
	...
	if(mysqli_num_rows($query)>0){
		mysqli_query($connection,"UPDATE `websites` SET `called`='1' WHERE `id`='$id'");
