...
$query=mysqli_query($connection,"SELECT `id`,`name`,`phone`,`purpose`,`called`,`completed`,`dateandtime` FROM `websites` WHERE `completed`='1'");
...
{
	echo "<p style=font-size:50px>No old clients</p>";
}
?>
</body>
</html>