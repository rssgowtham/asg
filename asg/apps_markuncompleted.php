...
<form align="center" name="form" action="apps_markuncompleted.php" onsubmit="return validate()" method="POST">
	<?php
...
if(mysqli_num_rows($query)>0){
	mysqli_query($connection,"UPDATE `apps` SET `completed`='0' WHERE `id`='$id'");
