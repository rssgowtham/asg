...
<form align="center" name="form" action="webs_markuncompleted.php" onsubmit="return validate()" method="POST">
	<?php
...
if(mysqli_num_rows($query)>0){
	mysqli_query($connection,"UPDATE `websites` SET `completed`='0' WHERE `id`='$id'");
