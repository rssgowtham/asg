...
<form align="center" name="form" action="apps_markcalled.php" onsubmit="return validate()" method="POST">
<?php
...
if(isset($_REQUEST['submitted']))
{
	...
	if(mysqli_num_rows($query)>0){
		mysqli_query($connection,"UPDATE `apps` SET `called`='1' WHERE `id`='$id'");
