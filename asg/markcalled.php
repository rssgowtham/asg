...
<form align="center" name="form" action="markcalled.php" onsubmit="return validate()" method="POST">
<?php
...
if(isset($_REQUEST['submitted']))
{
	...
	if(mysqli_num_rows($query)>0){
		mysqli_query($connection,"UPDATE `clients` SET `called`='1' WHERE `id`='$id'");
		echo "id no ".$id." marked as called";
	}
	else
	{
	echo "invalid id";	
