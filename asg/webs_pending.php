...
$query=mysqli_query($connection,"SELECT `id`,`name`,`phone`,`purpose`,`called`,`completed`,`dateandtime` FROM `websites` WHERE `called`='1' and `completed`='0'");
...
{
	echo "<p style=font-size:50px>No pending works</p>";
}
?>
</body>
</html>