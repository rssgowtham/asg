...
<form align="center" name="form" action="apps_markcompleted.php" onsubmit="return validate()" method="POST">
	<?php
...
if(mysqli_num_rows($query)>0){
	mysqli_query($connection,"UPDATE `apps` SET `completed`='1' WHERE `id`='$id'");
