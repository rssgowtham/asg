...
<form align="center" name="form" action="markuncalled.php" onsubmit="return validate()" method="POST">
		<?php
...
if(mysqli_num_rows($query)>0){
	mysqli_query($connection,"UPDATE `clients` SET `called`='0' WHERE `id`='$id'");
